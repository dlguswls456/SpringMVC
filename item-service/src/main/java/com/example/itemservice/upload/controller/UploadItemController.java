package com.example.itemservice.upload.controller;
...
import com.example.itemservice.upload.domain.Item;
import com.example.itemservice.upload.domain.UploadFile;
import com.example.itemservice.upload.domain.UploadItemRepository;
import com.example.itemservice.upload.file.FileStore;
...
public class UploadItemController {
    ...
    public String saveItem(@ModelAttribute("form") ItemForm form, RedirectAttributes redirectAttributes)
                                    throws IOException {
